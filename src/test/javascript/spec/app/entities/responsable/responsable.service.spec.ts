    ...
    describe('Responsable Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/responsables';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a Responsable', () => {
                service.create(new Responsable(null)).subscribe(received => {
            ...
            it('should update a Responsable', () => {
                service.update(new Responsable(123)).subscribe(received => {
            ...
            it('should return a Responsable', () => {
