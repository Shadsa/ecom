...
describe('Service Tests', () => {
    describe('QRCode Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(QRCodeService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/qr-codes';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a QRCode', () => {
                service.create(new QRCode(null)).subscribe(received => {
            ...
            it('should update a QRCode', () => {
                service.update(new QRCode(123)).subscribe(received => {
